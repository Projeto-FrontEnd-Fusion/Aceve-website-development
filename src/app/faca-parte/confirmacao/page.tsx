export default function ConfirmationPage() {
  return (
    <section className="flex items-center justify-center min-h-screen bg-purple-100 p-4">
      <div className="w-[200px] h-[200px] md:w-[260px] md:h-[250px]  bg-gray-100 rounded-[16px] border border-purple-600 flex flex-col items-center justify-center p-4 text-center">
