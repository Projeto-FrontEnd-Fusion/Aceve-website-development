...
export const whoweareDetails = {
  ...
  whoweareImg2:
    "https://files.edgestore.dev/nh2rz4kiwkl7w411/publicImages/_public/post/57a2c859-df8c-4a29-9e0a-d8060539ec9a.png",
  p1: `Somos uma organização não governamental (ONG) dedicada a apoiar mulheres em situação de vulnerabilidade. Nosso objetivo é proporcionar a elas as ferramentas necessárias para alcançar a autonomia econômica e desenvolver habilidades socioemocionais essenciais.`,

  p2: `Acreditamos que, ao capacitar essas mulheres, estamos fortalecendo não apenas suas trajetórias individuais, mas também os laços familiares e comunitários. Além disso, incentivamos o empreendedorismo como uma forma de empoderamento, permitindo que elas criem seus próprios negócios e alcancem independência financeira.`,

  p3: `Tudo isso é feito com amor e dedicação, visando construir um mundo mais igualitário e acolhedor.`,
...
export const whoweareWorks = [
  ...
  {
    workImage:
      "https://i.postimg.cc/65Gp1s7B/healthicons-world-care-outline.png",
...
export const whoweareInfoDetails = {
  title1: "Área de atuação",
  title2: "Desafios",
  title3: "Território",
  img1: "https://s3-alpha-sig.figma.com/img/6a54/3e61/7b31d1888aa77eb960ba0d4b49c249a4?Expires=1731888000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=kbMnWXcyL6nD7qPADFUe73w7mBAKi8lN2hxzKfWBnk5b5Nhi7r5N1tHfQZA38px7pcCCQIwUNMgPwYJiPSePL1gPlJxJgbEZi4XoU~ZqVaLBOdmc~OTHFDEx7bCEfLL-CSsK5fBN1ZUiq5BdU-U2Mmny2LlK7BGk40I6Lbxt2OUPhq1AZ9m1bdxSIBRlrnbYrka5dzcx8rR0Zl83jAG1JD6tu-RxirFbEX9i6lAeb2Qdw03ySc-1vKwbcpeb~5etEp2ggydzrkTuyP70zOZfTTK1sT7O276EW9jWL~cbquLdf3i1VpHGgTI--d-mkJOdZeAoC3vbchc0Qahnr7-LgQ__",
  ...
  p2: [
    ...
    "Fazer com que os governantes entendam a realidade das pessoas que vivem em situações de vulnerabilidade e apoiar organizações que combatem os problemas provocados pelas desigualdades é fundamental para construirmos um país mais justo e solidário para todos.",
  ],
