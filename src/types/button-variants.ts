...
export const buttonVariants = {
  ...
  'disabled': 'relative  cursor-not-allowed select-none  bg-grey-300 text-grey-500',
  'active-route': 'bg-primary-200 text-primary-800 hover:bg-primary-300 active:bg-primary-400 focus:outline-grey-400',
