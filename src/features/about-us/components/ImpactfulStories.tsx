  ...
  const impactfulStories = [
    {
      ...
      paragraph:
        <p>Com o apoio da ONG, a ex-técnica de enfermagem <span className="font-bold">Jucelia Pereira</span>, 44, fundou uma bem-sucedida loja de cosméticos. Sua missão, no entanto, vai além do negócio: como voluntária, ela agora dedica seu tempo para inspirar novas empreendedoras, provando que é possível transformar a própria história.</p>,
    ...
    },
    {
      ...
      paragraph:
        <p>Aluna da primeira turma de Empreendedorismo da ONG Violeta Eliz, <span className="font-bold">Kauanny Soares</span>, 21, aplicou o conhecimento em Marketing Digital para se lançar como Lash e Designer de Sobrancelhas. Agora, ela retribui como voluntária, usando seu talento para impulsionar o projeto nas redes sociais.</p>,
      image: ImpactfulStory3,
      imageAlt: "Kauanny Soares, jovem, com tiara, segurando uma pinça de design de sobrancelhas, simbolizando sua atuação como lash e designer",
    },
  ];
